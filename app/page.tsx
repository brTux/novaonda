...
const data = [
  { name: "Seg", conversas: 400, vendas: 2400 },
  { name: "Ter", conversas: 300, vendas: 1398 },
  { name: "Qua", conversas: 200, vendas: 9800 },
  { name: "Qui", conversas: 278, vendas: 3908 },
  { name: "Sex", conversas: 189, vendas: 4800 },
  { name: "Sáb", conversas: 239, vendas: 3800 },
  { name: "Dom", conversas: 349, vendas: 4300 },
];
  ...
  return (
    <div className="flex-1 overflow-auto p-6 md:p-10 space-y-10 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "Total de Leads", value: "12,450", change: "+12.5%", icon: Users, color: "text-[#ff5100] bg-[#fff5f0]" },
          { label: "Vendas Pix", value: "R$ 42.150", change: "+5.4%", icon: Zap, color: "text-[#ffb800] bg-[#fffcf0]" },
          { label: "Mensagens", value: "84,302", change: "+18.2%", icon: MessageSquare, color: "text-blue-500 bg-blue-50" },
          { label: "Performance", value: "94.2%", change: "+2.1%", icon: TrendingUp, color: "text-emerald-500 bg-emerald-50" },
        ].map((item) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 glass-card p-8 bg-white border border-slate-100">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-lg font-bold text-[#2d3339]">Desempenho de Vendas</h3>
            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex gap-4 group cursor-pointer border-b border-slate-50 pb-4 last:border-0 last:pb-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-[#2d3339] truncate">Novo lead via Telegram</p>
                  <p className="text-[11px] text-[#555d66] font-medium mt-0.5">Há {i * 2} minutos • Bot #82</p>
                </div>
              </div>
            ))}
          </div>
